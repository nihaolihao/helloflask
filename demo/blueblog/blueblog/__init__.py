...
from blueblog.extensions import bootstrap, db, login_manager, csrf, ckeditor, mail, moment, toolbar, migrate
...
#         for q in current_app.extensions['sqlalchemy'].queries:
